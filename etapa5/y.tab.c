...
case 1:
#line 50 "parser.y"
	{yyval.astree = yystack.l_mark[0].astree; astPrintTree(yyval.astree); astPrintTreeSrc(yyval.astree); TAC* root = codeGenerate(yyval.astree); tacPrintList(root);}
break;
case 2:
#line 55 "parser.y"
